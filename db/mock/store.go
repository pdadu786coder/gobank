...
// Source: github.com/pdadu/learn/db/sqlc (interfaces: Store)
...
func (m *MockStore) TrasnferTx(arg0 context.Context, arg1 db.TransferTxParam) (db.TransferTxResult, error) {
	m.ctrl.T.Helper()
